...
class SafebrowsingPage extends React.Component {
  ...
  render () {
    return <div className='errorContent' id='safebrowsingPage' style={{height: 'auto'}}>
      ...
      <div className='safebrowsingErrorText'>
        <span data-l10n-id='safebrowsingErrorText'></span>
      </div>
      <div className='buttons'>
        {this.state.advanced
          ? <div>
            <Button l10nId='safebrowsingErrorHideAdvanced' className='subtleButton' onClick={this.onAdvancedToggle.bind(this)}/>
            <div className='subtleText'><p data-l10n-id='safebrowsingErrorInfo'></p><br/><p data-l10n-id='safebrowsingErrorBypass'></p></div></div>
