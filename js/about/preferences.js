  ...
  render () {
    ...
    return <div>
      ...
      <SettingsList dataL10nId='privateDataMessage'>
        ...
        <SettingCheckbox dataL10nId='allSiteCookiesNoLocalStorage' prefKey={settings.SHUTDOWN_CLEAR_COOKIES_NO_LOCAL_STORAGE} settings={this.props.settings} onChangeSetting={this.props.onChangeSetting} />
