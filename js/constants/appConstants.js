...
const appConstants = {
  ...
  APP_TAB_PINNED: _,
  APP_DRAG_STARTED: _,
  APP_TAB_DRAG_STARTED: _,
  APP_TAB_DRAG_CANCELLED: _,
  APP_TAB_DRAG_COMPLETE: _,
  APP_TAB_DRAG_DETACH_REQUESTED: _,
  APP_TAB_DRAG_SINGLE_TAB_MOVED: _,
  APP_TAB_DRAG_CHANGE_GROUP_DISPLAY_INDEX: _,
  APP_TAB_DRAG_CHANGE_WINDOW_DISPLAY_INDEX: _,
  APP_TAB_DRAG_MOUSEOVER_OTHER_WINDOW_TAB: _,
  APP_DRAG_ENDED: _,
