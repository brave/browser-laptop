{
  ...
  "scripts": {
    ...
    "unittest-cov-helper": "cross-env NODE_ENV=test ./node_modules/mocha/bin/_mocha --globals chrome,DOMParser,XMLSerializer",
    "unittest-cov": "node --harmony node_modules/istanbul/lib/cli.js cover npm run unittest-cov-helper --report lcovonly --report html --report text -x \"test/unit/**/*Test.js\" -- \"test/unit/**/*Test.js\"",
