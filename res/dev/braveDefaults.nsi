...
Function .onInit
  ...
  ${OrIf} $5 != ""
    ...
    DeleteRegKey HKCU "Software\Classes\Applications\Brave.exe"
  ${Else}
    ...
    WriteRegStr HKCU "Software\Classes\Applications\Brave.exe\shell\open" "FriendlyAppName" "Brave (old)"
  ${EndIf}
