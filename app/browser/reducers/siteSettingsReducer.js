    ...
    case appConstants.APP_ALLOW_FLASH_ONCE:
      {
        ...
        state = state.set(propertyName,
          siteSettings.mergeSiteSetting(state.get(propertyName), siteUtil.getOrigin(action.get('url')), 'flash', 1))
        break
      }
    case appConstants.APP_ALLOW_FLASH_ALWAYS:
      {
        ...
        state = state.set(propertyName,
          siteSettings.mergeSiteSetting(state.get(propertyName), siteUtil.getOrigin(action.get('url')), 'flash', expirationTime))
        break
      }
