...
const {braveShieldsDisabled} = require('../../../common/lib/shieldUtil')
...
class Navigator extends ImmutableComponent {
  ...
  onBraveMenu () {
    if (!braveShieldsDisabled(this.props.windowState)) {
  ...
  render () {
    ...
    const shieldDisabled = braveShieldsDisabled(this.props.windowState)
      ...
      <div className='navbarMenubarFlexContainer'>
        ...
        >
          ...
          <NavigationBar
            ...
            enableNoScript={siteUtil.enableNoScript(this.props.activeSiteSettings, this.props.appState)}
