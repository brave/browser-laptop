function LoginToolbar_Communication(){if(!chrome.extension.connect){this.sendMessage=function(a){};
return}this.port=chrome.extension.connect({name:"popup"});this.sendMessage=function(a){this.port.postMessage(a)
};this.port.onMessage.addListener(function(a){if(a.type=="changeLangage"){loginToolbar.refreshTranslations(a.tr1,a.tr2,a.tr3)
