...
function Popover_Communication(){if(!chrome.extension.connect){this.sendMessage=function(a){};
return}this.port=chrome.extension.connect({name:"popup"});this.sendMessage=function(a){this.port.postMessage(a)
};this.port.onMessage.addListener(function(a){switch(a.type){case"changeLangage":popover.communication.refreshTranslations(a.lang);
...
var PopoverHelpView=function(d,a){var j=this;this.controller=d;this.el=a;var g=null;
var f=null;var i=null;var h=null;var b=null;var c=null;var e=null;this.tr=function(k){return this.controller.tr(k)
};this.allowReverseAction=function(){return false};this.restoreState=function(k){};
this.rendered=function(){return this.el.children().size()!==0};this.render=function(){var k=this;
this.el.children().remove();k.el.addClass("navigator").addClass("menusmall");h=$("<div>",{"class":"menu"}).append($("<span>",{"class":"title",text:this.tr("TIPS")}));
...
this.renderRssFeed()}return k()}.bind(this))}};var SORT_CATEGORY="category";var SORT_NAME="name";
var SORT_MOSTUSED="mostused";var SORT_LASTUSED="lastused";var VIEW_NODATA="nodata";
var VIEW_CREDENTIALS="credentials";var VIEW_CATEGORIES="categories";var VIEW_LISTDETAILS="listdetails";
var DEFAULT_VIEW=VIEW_CREDENTIALS;var DEFAULT_SORT=SORT_NAME;var PopoverCredentialsView=function(j,g){var o=this;
this.controller=j;this.el=g;var m=[];var e=[];var f=[];var n={};var i={};var a={};
var d={};var l=null;var c=null;var k=null;var b=null;var h=null;this.tr=function(p){return this.controller.tr(p)
};this.allowReverseAction=function(){return false};this.rendered=function(){return this.el.children().size()!==0
};this.restoreState=function(q){var p=this;var r=p.currentState();if(q){c=q.view;
l=q.sort;k=q.selection}};this.currentState=function(){return{view:c,sort:l,selection:k}
...
l.generatePassword()});this.useAsDefaultsButton.click(function(){if(!l.isDefaults){l.controller.action.usageLog("generator","defaults");
...
}this.checkConfig()};this.checkConfig=function(m){if(m!==false){m=true}var o=this.pronounceableCheckbox.is(":checked");
if(o){this.lettersCheckbox.attr("checked",true).attr("disabled",true);this.symbolsCheckbox.removeAttr("checked").attr("disabled",true)
...
var k=this.symbolsCheckbox.is(":checked");if(!(n||p||k)){this.lettersCheckbox.attr("checked",true);
p=true}if(k&&!(n||p)){this.lettersCheckbox.attr("checked",true);p=true}this.lettersCheckbox.attr("disabled",!(n)||o);
this.digitsCheckbox.attr("disabled",!(p||k));this.symbolsCheckbox.attr("disabled",!(n||p)||o);
this.lettersCheckbox.button("refresh");this.digitsCheckbox.button("refresh");this.symbolsCheckbox.button("refresh");
this.pronounceableCheckbox.button("refresh");if(m){this.generatePassword()}var l=Math.round(this.lengthIndicator.slider("option","value")/h);
this.isDefaults=(f.size==l&&f.digits==n&&f.letters==p&&f.symbols==k&&f.pronounceable==o);
if(this.isDefaults){this.useAsDefaultsButton.addClass("disabled")}else{this.useAsDefaultsButton.removeClass("disabled")
}};this.saveDefaults=function(){var m=Math.round(this.lengthIndicator.slider("option","value")/h);
var n=this.digitsCheckbox.is(":checked");var p=this.lettersCheckbox.is(":checked");
...
return k[Math.floor(l/16)]+k[l%16]}};var PopoverGettingStartedView=function(a,e){var b=this;
