...
- Added more details on secure connections. ([#6157](https://github.com/brave/browser-laptop/issues/6157))
...
- Fix issues with exclusion list for Brave payments. ([#7940](https://github.com/brave/browser-laptop/issues/7940))
...
- Fixed keyboard shortcuts not working. ([#7491](https://github.com/brave/browser-laptop/issues/7491))
...
- Fixed open browser console (Shift+F8). ([#7448](https://github.com/brave/browser-laptop/issues/7448))
- Fixed YouTube.com player - updated ad blocking evasion. ([#7432](https://github.com/brave/browser-laptop/issues/7432))
