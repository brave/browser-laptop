...
## [0.11.6](https://github.com/brave/browser-laptop/releases/v0.11.6dev)
 - Added Ledger Beta!
 - Added autofill for forms
 - Added enhancements for bookmarks
 - Added browser history
 - Fixed handling URLs with whitespace in it ([#3167](https://github.com/brave/browser-laptop/issues/3167))
