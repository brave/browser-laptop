...
describe('ledgerState unit test', function () {
  ...
  describe('setPublishersOption', function () {
    it('null case', function () {
      const result = ledgerState.setPublishersOption(defaultState)
      assert.deepEqual(result.toJS(), defaultState.toJS())
    })

    it('publisher list is empty', function () {
      const result = ledgerState.setPublishersOption(defaultState, Immutable.List())
      assert.deepEqual(result.toJS(), defaultState.toJS())
    })

    it('publisher is missing publisherKey', function () {
      const result = ledgerState.setPublishersOption(defaultState, Immutable.fromJS([
        {
          verified: true,
