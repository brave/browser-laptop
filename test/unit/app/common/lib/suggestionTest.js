...
describe('suggestion unit tests', function () {
  ...
  describe('normalizeLocation', function () {
    ...
    it('normalizes location', function () {
      ...
      assert.ok(suggestion.normalizeLocation('http://www.wowww.com') === 'wowww.com', 'location not modified')
      assert.ok(suggestion.normalizeLocation('https://www.wowww.com') === 'wowww.com', 'location not modified')
