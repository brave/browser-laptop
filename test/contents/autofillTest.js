  ...
  describe('address', function () {
    ...
    beforeEach(function * () {
      ...
      yield this.app.client
        ...
        .setValue(organizationInput, organization)
        .click(streetInput)
        .setValue(streetInput, streetAddress)
        .click(cityInput)
        .setValue(cityInput, city)
        .click(stateInput)
        .setValue(stateInput, state)
        .click(postalCodeInput)
        .setValue(postalCodeInput, postalCode)
    ...
    it('autofills the updated address when edited', function * () {
      yield this.app.client
        ...
        .click(phoneInput)
        .keys(Brave.keys.END)
        .setValue(phoneInput, phone + '123')
        .click(emailInput)
        .keys(Brave.keys.END)
        .setValue(emailInput, email + 'mm')
        .click(saveAddressButton)
        .windowByUrl(Brave.browserWindowUrl)
        .waitUntil(function () {
          return this.getAppState().then((val) => {
